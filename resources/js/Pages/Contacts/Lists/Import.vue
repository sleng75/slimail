...
const uploadAndPreview = async () => {
    ...
    try {
        const response = await fetch('/contact-lists/import/preview', {
            method: 'POST',
            body: formData,
            headers: {
...
const submitImport = () => {
    form.post(`/contact-lists/${props.list.id}/import`, {
        onSuccess: () => {
...
<template>
    <AppLayout>
        <Head :title="`Importer dans ${list.name}`" />
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-6">
                ...
                <h1 class="mt-2 text-2xl font-bold text-secondary-900">Importer dans "{{ list.name }}"</h1>
                <p class="mt-1 text-sm text-secondary-500">Ajoutez des contacts à cette liste depuis un fichier CSV</p>
            </div>
            ...
            <div v-if="step === 1" class="space-y-6">
                <div class="bg-white rounded-xl border border-gray-100 p-6">
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-100">
                        <a
                            href="/contact-lists/import/template"
