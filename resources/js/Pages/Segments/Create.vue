...
<template>
    <AppLayout>
        <Head title="Nouveau segment" />

        <div class="max-w-4xl mx-auto space-y-6">
            <!-- Header -->
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Nouveau segment</h1>
                <p class="text-gray-500">Créez un segment pour cibler vos contacts selon des critères</p>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex items-center justify-end gap-3">
                    ...
                    >
                        ...
                        <span v-else>Créer le segment</span>
                    </button>
                </div>
            </form>
        </div>
